  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={[styles.ContentContainer]}>
        <Text style={[styles.ContentText]}>
        You can use Voice Recorder to record your talks and 
        AI will translate them to Text and SignLanguage.
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={[styles.ContentText]}>
          ...
          1- You can use Voice Recorder to record your talks
           ...
           You can use Camera to translate SignLanguage
            to Text using AI.{'\n'}
