    ...
    return recordings.map((recordingLine, index) => {
      return (
        <View key={index} style={styles.row}>
          ...
          <AntDesign  style={styles.button} name="play" size={30} color="#034b6e" />
          </TouchableOpacity>
        </View>
  ...
  return (
    ...
    <View style={styles.textView}>
      ...
      title={recording ? 'Stop Recording' : 'Start Recording'}
        ...
        >
           {value.trim() ? (
          <Ionicons size={30} name="md-send-sharp" color="#034b6e"  style={{marginLeft:'-1%'}}/>
       
        ) : (
          <Ionicons  name="mic-circle" size={45} color="#034b6e"  style={{marginLeft:'-1%'}} />
        )}
      </TouchableOpacity>
  {getRecordingLines()}
